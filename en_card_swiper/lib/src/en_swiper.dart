...
class ENSwiper extends StatefulWidget {
  ...
  final ENSwiperPlugin? pagination;

  ///the swiper control button plugin
  final ENSwiperPlugin? control;

  ///other plugins, you can custom your own plugin
  final List<ENSwiperPlugin>? plugins;
...
abstract class _SwiperTimerMixin extends State<ENSwiper> {
  Timer? _timer;
  late ENSwiperController _controller;

  @override
  void initState() {
    super.initState();
    _controller = widget.controller ?? ENSwiperController();
  ...
  @override
  void didUpdateWidget(ENSwiper oldWidget) {
...
class _SwiperState extends _SwiperTimerMixin {
  ...
  bool _getReverse(ENSwiper widget) => widget.transformer?.reverse ?? false;
    ...
    if (widget.pagination != null) {
      ...
      if (widget.outer) {
        return _buildOuterPagination(
            widget.pagination! as ENSwiperPagination,
